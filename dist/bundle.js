...
function forms(formSelector, modalTimerId) {
  ...
  function showStatusMessage(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)(modalContentSelector, modalSelector, modalTimerId);
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])("2026-02-01", ".timer");
